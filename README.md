...
Com essa formatação, o arquivo `README.md` está mais organizado e fácil de ler. Copie e cole o conteúdo acima diretamente no seu arquivo.# Trabalho Fase 3 - Substitutiva
...
### Configuração do Keycloak
- **URL do Keycloak**: Certifique-se de que o Keycloak está rodando em `http://localhost:8080`.
- **Realm**: `postech-fase3- **Client**: `api-compradores`
- **Client Secret**: Configurado no Keycloak (veja no painel administrativo do cliente).
